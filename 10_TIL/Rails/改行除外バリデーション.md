...
## 🔗 参考リンク
- [Ruby公式 正規表現](https://docs.ruby-lang.org/ja/latest/doc/spec=2fregexp.html)
- [Railsガイド - バリデーション - format](https://railsguides.jp/active_record_validations.html#format)
- [wikipedia - 改行](https://ja.wikipedia.org/wiki/%E6%94%B9%E8%A1%8C%E3%82%B3%E3%83%BC%E3%83%89)
## 💭 感想・次への課題
- 改行は`\n`だけでなく複数あると初めて知った
- `\R`を使えば色々と対応出来る